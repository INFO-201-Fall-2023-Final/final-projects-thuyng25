    ...
    tabPanel("Adaptive Strategies",
      sidebarLayout(
        ...
        mainPanel(
          ...
          h3("Interactive Guide:"),
          p("Use the drop-down menu to choose a year. You can hover over the data points to see the names of the countries. Alternatively, you can select a specific country
            and it will be highlighted in a different color."),
